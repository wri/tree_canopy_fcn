...
IC='projects/wri-datalab/lidar-lulc/greenspace/belohorizonte-naip-v1'
# CSV='belohorizonte-plieades-v1-uris.csv'
# IC='projects/wri-datalab/lidar-lulc/greenspace/belohorizonte-plieades-v1'
NO_DATA=4
